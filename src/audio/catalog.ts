...
const soundPath = (file: string) => `${BASE}sounds/${file}`
...
export const SOUND_CATALOG: SoundItem[] = [
  // --- Nature & Water ---
  {
    ...
    audioUrl: soundPath('rain-on-window.opus'),
    icon: '🌧️',
    description:
  ...
  },
  {
    ...
    category: 'nature',
    sourceType: 'audio-file',
    audioUrl: soundPath('rain-soft-thunder.opus'),
    icon: '⛈️',
  ...
  },
  {
    ...
    category: 'nature',
    sourceType: 'audio-file',
    audioUrl: soundPath('rain-under-umbrella.opus'),
    icon: '☂️',
    description:
  ...
  },
  {
    ...
    category: 'nature',
    sourceType: 'audio-file',
    audioUrl: soundPath('rain-on-umbrella-soft.opus'),
    icon: '🌂',
  ...
  },
  {
    ...
    category: 'nature',
    sourceType: 'audio-file',
    audioUrl: soundPath('ocean-waves-gentle.opus'),
    icon: '🌊',
  ...
  },
  {
    ...
    category: 'nature',
    sourceType: 'audio-file',
    audioUrl: soundPath('ocean-waves-foam.opus'),
    icon: '🏖️',
  ...
  },
  {
    ...
    category: 'nature',
    sourceType: 'audio-file',
    audioUrl: soundPath('ocean-waves-birds.opus'),
    icon: '🕊️',
  ...
  },
  {
    ...
    category: 'nature',
    sourceType: 'audio-file',
    audioUrl: soundPath('forest-brook-gentle.opus'),
    icon: '💧',
  ...
  },
  {
    ...
    category: 'nature',
    sourceType: 'audio-file',
    audioUrl: soundPath('forest-brook-summer.opus'),
    icon: '🌲',
  ...
  },
  {
    ...
    category: 'nature',
    sourceType: 'audio-file',
    audioUrl: soundPath('night-crickets-calm.opus'),
    icon: '🌙',
  ...
  },
  {
    ...
    category: 'nature',
    sourceType: 'audio-file',
    audioUrl: soundPath('night-crickets-buzz.opus'),
    icon: '🦗',
    description:
  ...
  },
  {
    ...
    category: 'nature',
    sourceType: 'audio-file',
    audioUrl: soundPath('night-countryside-pasture.opus'),
    icon: '🌌',
    description:
  ...
  // --- Cozy & Places (Comfort) ---
  {
    ...
    category: 'comfort',
    sourceType: 'audio-file',
    audioUrl: soundPath('train-cabin-interior.opus'),
    icon: '🚂',
  ...
  },
  {
    ...
    category: 'comfort',
    sourceType: 'audio-file',
    audioUrl: soundPath('train-rail-clatter.opus'),
    icon: '🛤️',
  ...
  },
  {
    ...
    category: 'comfort',
    sourceType: 'audio-file',
    audioUrl: soundPath('coffee-shop-ambience.opus'),
    icon: '☕',
  ...
  },
  {
    ...
    category: 'comfort',
    sourceType: 'audio-file',
    audioUrl: soundPath('coffee-shop-barista.opus'),
    icon: '🥐',
  ...
  // --- ASMR & Tactile ---
  {
    ...
    category: 'asmr',
    sourceType: 'audio-file',
    audioUrl: soundPath('book-pages-turning.opus'),
    icon: '📖',
  ...
  },
  {
    ...
    category: 'asmr',
    sourceType: 'audio-file',
    audioUrl: soundPath('reading-pages-soft.opus'),
    icon: '📚',
  ...
  },
  {
    ...
    category: 'asmr',
    sourceType: 'audio-file',
    audioUrl: soundPath('plastic-crinkle-asmr.opus'),
    icon: '✨',
